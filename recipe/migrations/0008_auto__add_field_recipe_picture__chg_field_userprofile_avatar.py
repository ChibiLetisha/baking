...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe.picture'
        db.add_column(u'recipe_recipe', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'UserProfile.avatar'
        db.alter_column(u'recipe_userprofile', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Recipe.picture'
        db.delete_column(u'recipe_recipe', 'picture')
        ...
        # Changing field 'UserProfile.avatar'
        db.alter_column(u'recipe_userprofile', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
