...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TipComments'
        db.create_table(u'recipe_tipcomments', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('post', self.gf('django.db.models.fields.TextField')()),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('tip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipe.Tip'])),
        ))
        db.send_create_signal(u'recipe', ['TipComments'])
    ...
    models = {
        ...
        u'recipe.recipecomments': {
            'Meta': {'object_name': 'RecipeComments'},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.TextField', [], {}),
        ...
        u'recipe.tipcomments': {
            'Meta': {'object_name': 'TipComments'},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.TextField', [], {}),
            'tip': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['recipe.Tip']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
